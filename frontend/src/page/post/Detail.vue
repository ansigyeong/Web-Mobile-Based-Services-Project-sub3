    ...
    <b-card>
      <div class="content-detail-content-info">
        <div class="content-detail-content-info-left">
          ...
          <div class="content-detail-content-info-left-subject">{{ questionTitle }}</div>
        </div>
      ...
      <div class="content-detail-content">{{ questionContext }}</div>
      <div class="content-detail-button">
        <b-button pill variant="outline-primary" @click="updateData">수정</b-button>
        <b-button pill variant="outline-danger" @click="deleteData">삭제</b-button>
      </div>
...
export default {
  ...
  data() {
    ...
    return {
			questionTitle: this.$route.query.title,
	  	questionContext: this.$route.query.context,
      contentId: contentId,
